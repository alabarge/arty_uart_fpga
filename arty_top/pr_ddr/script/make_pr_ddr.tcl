...
# IP Build 3669848 on Fri Oct 14 08:30:02 MDT 2021
#
...
if { [get_property IS_LOCKED [ get_files -norecurse mb_design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/pr_ddr.gen/sources_1/bd/mb_design/hdl/mb_design_wrapper.vhd" ]
} else {
