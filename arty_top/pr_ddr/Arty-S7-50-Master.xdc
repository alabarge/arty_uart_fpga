...
set_property -dict {PACKAGE_PIN J10} [get_ports vp_in]
set_property -dict {PACKAGE_PIN K9} [get_ports vn_in]

## ChipKit Outer Analog Header - as Single-Ended Analog Inputs
## NOTE: These ports can be used as single-ended analog inputs with voltages from 0-3.3V (ChipKit analog pins A0-A5) or as digital I/O.
## WARNING: Do not use both sets of constraints at the same time!
## NOTE: The following constraints should be used with the XADC IP core when using these ports as analog inputs.
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports vauxp0]
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports vauxn0]
...
set_property -dict {PACKAGE_PIN E12 IOSTANDARD LVCMOS33} [get_ports vauxp9]
set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33} [get_ports vauxn9]
set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS33} [get_ports vauxp2]
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports vauxn2]
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports vauxp10]
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports vauxn10]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports vauxp11]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports vauxn11]
...
set_property -dict {PACKAGE_PIN B14 IOSTANDARD LVCMOS33} [get_ports vauxp8]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports vauxn8]
#set_property -dict { PACKAGE_PIN D16   IOSTANDARD LVCMOS33 } [get_ports { vauxp3 }]; #IO_L9P_T1_DQS_AD3P_15 Sch=ad_p[3]   ChipKit pin=A8
#set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { vauxn3 }]; #IO_L9N_T1_DQS_AD3N_15 Sch=ad_n[3]   ChipKit pin=A9
