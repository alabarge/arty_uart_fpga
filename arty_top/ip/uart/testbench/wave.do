...
add wave -noupdate -radix hexadecimal -childformat {{/uart_tb/UART_TOP_I/UART_CTL_I/tx.state -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/tx.data -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/tx.head -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/tx.tail -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/tx.irq -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/tx.wr -radix hexadecimal}} -subitemconfig {/uart_tb/UART_TOP_I/UART_CTL_I/tx.state {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/tx.data {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/tx.head {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/tx.tail {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/tx.irq {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/tx.wr {-height 15 -radix hexadecimal}} /uart_tb/UART_TOP_I/UART_CTL_I/tx
add wave -noupdate -radix hexadecimal -childformat {{/uart_tb/UART_TOP_I/UART_CTL_I/rx.state -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.data -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.head -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.tail -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.timeout -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.count -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.msg -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.irq -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.wr -radix hexadecimal} {/uart_tb/UART_TOP_I/UART_CTL_I/rx.rd -radix hexadecimal}} -subitemconfig {/uart_tb/UART_TOP_I/UART_CTL_I/rx.state {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.data {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.head {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.tail {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.timeout {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.count {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.msg {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.irq {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.wr {-height 15 -radix hexadecimal} /uart_tb/UART_TOP_I/UART_CTL_I/rx.rd {-height 15 -radix hexadecimal}} /uart_tb/UART_TOP_I/UART_CTL_I/rx
