...
#
# make_pr_ddr.tcl: Tcl script for re-creating project 'pr_ddr'
#
# Generated by Vivado on Thu Dec 29 09:53:55 -0800 2022
...
#
# 1. This project restoration tcl script (make_pr_ddr.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/ARTY-I/arty_uart_fpga/arty_top/pr_ddr/pr_ddr.srcs/sources_1/bd/mb_design/ip/mb_design_mig_7series_0_0/board.prj"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/ARTY-I/arty_uart_fpga/arty_top/packages/lib_pkg.vhd"
#    "D:/ARTY-I/arty_uart_fpga/arty_top/ip/pr_ddr/arty_top.vhd"
#    "D:/ARTY-I/arty_uart_fpga/arty_top/ip/pr_ddr/Arty-S7-50-Master.xdc"
#    "D:/ARTY-I/arty_uart_fpga/arty_top/ip/pr_ddr/arty_top.sdc"
#    "D:/ARTY-I/arty_uart_fpga/arty_top/ip/pr_ddr/arty_top_tb.vhd"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ip/pr_ddr/mb_design_mig_7series_0_0/board.prj"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/ip/pr_ddr/arty_top.vhd"]"\
 "[file normalize "$origin_dir/ip/pr_ddr/Arty-S7-50-Master.xdc"]"\
 "[file normalize "$origin_dir/ip/pr_ddr/arty_top.sdc"]"\
 "[file normalize "$origin_dir/ip/pr_ddr/arty_top_tb.vhd"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set script_file "make_pr_ddr.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/pr_ddr"]"
...
set file "$origin_dir/ip/pr_ddr/arty_top.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "mb_design_mig_7series_0_0/board.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/ip/pr_ddr/Arty-S7-50-Master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ip/pr_ddr/Arty-S7-50-Master.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/ip/pr_ddr/arty_top.sdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ip/pr_ddr/arty_top.sdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/ip/pr_ddr/arty_top.sdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/ip/pr_ddr/arty_top.sdc"]" -objects $obj
...
set file "$origin_dir/ip/pr_ddr/arty_top_tb.vhd"
set file [file normalize $file]
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set_property CONFIG.NUM_MI {11} $axi_crossbar_0
  ...
  set_property CONFIG.enable_timer2 {0} $axi_timer_1
  ...
  # Create instance: stamp_0, and set properties
  set stamp_0 [ create_bd_cell -type ip -vlnv omniware.us:user:stamp:1.0 stamp_0 ]
  ...
  connect_bd_intf_net -intf_net Vaux11_0_1 [get_bd_intf_ports Vaux11_0] [get_bd_intf_pins xadc_wiz_0/Vaux11]
  ...
  connect_bd_intf_net -intf_net axi_crossbar_0_M01_AXI [get_bd_intf_pins axi_crossbar_0/M01_AXI] [get_bd_intf_pins microblaze_0_axi_intc/s_axi]
  connect_bd_intf_net -intf_net axi_crossbar_0_M02_AXI [get_bd_intf_pins axi_crossbar_0/M02_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M03_AXI [get_bd_intf_pins axi_crossbar_0/M03_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M04_AXI [get_bd_intf_pins axi_crossbar_0/M04_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M05_AXI [get_bd_intf_pins axi_crossbar_0/M05_AXI] [get_bd_intf_pins axi_timer_1/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M06_AXI [get_bd_intf_pins axi_crossbar_0/M06_AXI] [get_bd_intf_pins stamp_0/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M07_AXI [get_bd_intf_pins axi_crossbar_0/M07_AXI] [get_bd_intf_pins axi_uartlite_1/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M08_AXI [get_bd_intf_pins axi_crossbar_0/M08_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  connect_bd_intf_net -intf_net axi_crossbar_0_M09_AXI [get_bd_intf_pins axi_crossbar_0/M09_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_0_M10_AXI [get_bd_intf_pins axi_crossbar_0/M10_AXI] [get_bd_intf_pins axi_gpio_2/S_AXI]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports led] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports oled] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports stdio_uart] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net axi_uartlite_1_UART [get_bd_intf_ports cm_uart] [get_bd_intf_pins axi_uartlite_1/UART]
  ...
  connect_bd_net -net ddr_clock_1 [get_bd_ports sys_clk_i] [get_bd_pins mig_7series_0/sys_clk_i]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_crossbar_0/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk] [get_bd_pins stamp_0/s_axi_aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins axi_crossbar_0/aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn] [get_bd_pins stamp_0/s_axi_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs stamp_0/S_AXI/Reg] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse mb_design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/pr_ddr/pr_ddr.gen/sources_1/bd/mb_design/hdl/mb_design_wrapper.vhd" ]
} else {
